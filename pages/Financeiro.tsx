    ...
    <div>
        ...
        <div className="flex flex-col sm:flex-row gap-3 items-stretch sm:items-center">
           ...
           <div className="flex gap-2">
             <button className="flex-1 sm:flex-none flex items-center justify-center gap-2 bg-white border border-slate-300 text-slate-700 font-bold text-sm px-4 py-2 rounded-lg hover:bg-slate-50 transition-colors">
               ...
               <span className="whitespace-nowrap">Hoje: 17 de Julho</span>
             </button>
      ...
      <div className="bg-white border border-slate-200 rounded-xl overflow-hidden">
        ...
        <div className="p-4 border-b border-slate-200 flex flex-col md:flex-row justify-between items-center gap-4">
           <nav className="flex gap-6 text-sm font-bold overflow-x-auto w-full md:w-auto pb-2 md:pb-0">
             <button className="text-primary border-b-2 border-primary pb-4 -mb-4.5 whitespace-nowrap">Movimentações do Dia</button>
